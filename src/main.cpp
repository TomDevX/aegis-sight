...
// ============================================================
#if !defined(ENABLE_API_TEST) && !defined(ENABLE_MIC_TEST) && !defined(ENABLE_MIC_SPEAKER_TEST) && !defined(ENABLE_SPEAKER_TEST) && !defined(ENABLE_ULTRASONIC_TEST) && !defined(ENABLE_MPU6050_TEST) && !defined(ENABLE_MOTION_ULTRA_TEST) && !defined(ENABLE_MIC_AI_TEST) && !defined(ENABLE_MIC_AI_CAM_TEST) && !defined(ENABLE_CAMERA)
void setup() {
    initSerial();
    checkPSRAM();
